...
int  _W99683_Select_Packet_Size=1022;
...
static VOID  W99683Cam_Disconnect(USB_DEV_T *dev, VOID *ptr)
{
    static const CHAR proc[] = "W99683Cam_Disconnect";
       sysprintf("W99683Cam_Disconnect() \n"); 	
                          ...
                          const struct usb_device_id *devid)
{
    ...
    if (_W99683_Select_Packet_Size == 512)
    	actInterface = 1;  /* 512 */
    else if (_W99683_Select_Packet_Size == 768)
    	actInterface = 2;  /* 768 */
    else
    	actInterface = 3;  /* 1022 */
