/**************************************************************************//**
 * @file     DrawFont.c
 * @brief    Functions to draw font on panel
 *
...
void Draw_CurrentOperation(PCSTR pszString, int Retcode)
{
	...
	Draw_Clear(2, _LCM_HEIGHT_-1-g_Font_Height*3, _LCM_WIDTH_-3, _LCM_HEIGHT_-5-g_Font_Height*1,  COLOR_RGB16_BLACK);
	...
	if (Retcode < 0)
	{
		...
		DemoFont_PaintA(&s_sDemo_Font,
					...
					_LCM_HEIGHT_-1-g_Font_Height*3,
					Array1);
	}
	else
	{
