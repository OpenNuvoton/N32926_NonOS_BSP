...
typedef struct{
	...
	UINT32  card_remove_flag0;
	UINT32  card_Insert_flag0;
	UINT32  no_card_flag0;
	UINT32  card_remove_flag1;
	UINT32  card_Insert_flag1;
	UINT32  no_card_flag1;
	UINT32  card_remove_flag2;
	UINT32  card_Insert_flag2;
	UINT32  no_card_flag2;		
	...
	UINT32	F_SD1_LUN;
	UINT32	F_SD2_LUN;		
	INT32  gTotalSectors_SD0;
	INT32  gTotalSectors_SD1;
	INT32  gTotalSectors_SD2;			
	UINT32	F_SPI_LUN;
