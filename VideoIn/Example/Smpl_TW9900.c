/**************************************************************************//**
 * @file     Smpl_TW9900.c
 * @brief    Initialize TW9900 sample code
 *
...
UINT32 Smpl_TW9900_VGA(UINT8* pu8FrameBuffer0, UINT8* pu8FrameBuffer1, UINT8* pu8FrameBuffer2)
{
	...
	pVin->Init(TRUE, (E_VIDEOIN_SNR_SRC)eSYS_UPLL, 24000, eVIDEOIN_SNR_CCIR656);
#endif 
#ifdef __2ND_PORT__	
...
#ifdef __NTSC__	
	pVin->SetCropWinStartAddr(0x14,								//Vertical start position 	Y
							0x0);	
