...
extern PUINT8 g_pu8DecFrameBuffer;					/* The buffer for decoding output */
extern UINT8 g_au8BitstreamBuffer[];	/* The buffer for encoding output */

/*-----------------------------------------------------------------------*/
/*  Decode Input Wait parameter				                             */
/*-----------------------------------------------------------------------*/   
extern UINT8 g_au8DecInputWaitBuffer[];	/* Buffer for Decode Input Wait */
...
//VOID JpegEncTest(BOOL bIsPacketformat, UINT32 u32FrameBuf);
