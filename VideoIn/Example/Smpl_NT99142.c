/**************************************************************************//**
 * @file     Smpl_NT99142.c
 * @brief    Initialize NT99142 sample code
 *
...
struct NT_RegTable g_NT99142_InitTable[] =
{
...
VOID NT99142_Init(UINT32 nIndex, UINT32 u32Resolution)
{
    UINT32 u32Idx;
    UINT32 u32TableSize;
    UINT8  u8DeviceID;
    ...
    sysDelay(2);
    u32TableSize = g_NT99142_InitTable[0].uTableSize;
    ...
    u32TableSize = g_NT99142_InitTable[u32Resolution].uTableSize;
    psRegValue = g_NT99142_InitTable[u32Resolution].sRegTable;
    u8DeviceID = g_uOvDeviceID[nIndex];
    for(u32Idx=0; u32Idx<u32TableSize; u32Idx++, psRegValue++)
    {
        UINT8 u8Data;
...
UINT32 Smpl_NT99142_VGA(UINT8* pu8FrameBuffer0, UINT8* pu8FrameBuffer1, UINT8* pu8FrameBuffer2)
{
    ...
    pVin->SetDataFormatAndOrder(eVIDEOIN_IN_VYUY,               //NT99142
...
UINT32 Smpl_NT99142_HD(UINT8* pu8FrameBuffer0, UINT8* pu8FrameBuffer1, UINT8* pu8FrameBuffer2)
{
    ...
    NT99142_Init(9, REG_VALUE_HD720);
