...
void Draw_Wait_Status(UINT32 u32x, UINT32 u32y)
{
    ...
    {
    case 0:
        DemoFont_PaintA(&s_sDemo_Font, u32x, u32y, " | ");
        break;
    case 1:
        DemoFont_PaintA(&s_sDemo_Font, u32x, u32y, " / ");
        break;
...
//          Update at the bottom of center rectangle
//***********************************************************************************
...
//***********************************************************************************
// Draw_Init :
//          Initalize the VPOST, Font and prepared the related rectangle for display
//***********************************************************************************
void Draw_Init(void)
{
