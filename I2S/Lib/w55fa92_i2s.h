...
//#define __FPGA_AUDIO_24596MHz__
...
// E_DRVI2S_PIN_UNAVAILABLE        	Error in pin unavailable
// E_DRVI2S_DISABLED            	Error in disabled
...
// I2S channel function selections
...
#define DRVI2S_IRQ_PAUSE			P_PAUSE_IRQ_EN
...
VOID DrvI2S_SetDestBase(BOOL bType, UINT32 u32Address);
UINT32 DrvI2S_GetDestBase(BOOL bType);
VOID DrvI2S_SetDestLength(BOOL bType, UINT32 u32Length);
UINT32 DrvI2S_GetDestLength(BOOL bType);
INT DrvI2S_SetSampleRate (E_DRVI2S_SAMPLING  eSampleRate);
UINT32 DrvI2S_GetSampleRate (void);
