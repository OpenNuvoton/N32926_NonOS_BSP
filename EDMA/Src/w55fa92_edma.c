 ...
 * @file     w55fa92_edma.c
 * @version  V3.00
 * @brief    N3292x series EDMA driver source file
 *
			  ...
			  unsigned int dma_length)
{
	...
	if ((channel != 0) && (channel != 5) && (channel != 8))
	{
				...
				unsigned int dma_length)
{
	...
	// Set channel 0,5,8 transfer address and Scatter-Gather
...
{	
	...
	DrvEDMA_ClearCHForAPBDevice((E_DRVEDMA_CHANNEL_INDEX)channel);
