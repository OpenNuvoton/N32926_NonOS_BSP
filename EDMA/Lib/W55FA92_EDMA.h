 ...
 * @file     W55FA92_EDMA.h
 * @version  V3.00
 * @brief    N3292x series EDMA driver header file
 *
...
#define EDMA_ERR_NODEV				(0x01 | EDMA_ERR_ID)
#define EDMA_ERR_INVAL				(0x02 | EDMA_ERR_ID)
#define EDMA_ERR_BUSY				(0x03 | EDMA_ERR_ID)
