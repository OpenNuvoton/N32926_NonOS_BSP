/**************************************************************************//**
 * @file     W55FA93_VPOST_AMPIRE_800x480_16B.c
 * @version  V3.00
...
#if defined(__HAVE_AMPIRE_800x480_16B__)
...
void AMPIRE_800x480_16B_Init(void)
{
...
INT vpostLCMInit_AMPIRE_800x480_16B(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
...
INT32 vpostLCMDeinit_AMPIRE_800x480_16B(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
...
#endif    //__HAVE_AMPIRE_800x480_16B__
