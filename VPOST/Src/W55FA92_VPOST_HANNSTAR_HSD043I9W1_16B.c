/**************************************************************************//**
 * @file     W55FA92_VPOST_HANNSTAR_HSD043I9W1_16B.c
 * @version  V3.00
...
INT vpostLCMInit_HANNSTAR_HSD043I9W1_16B(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
...
INT32 vpostLCMDeinit_HANNSTAR_HSD043I9W1_16B(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
...
#endif    //__HAVE_HANNSTAR_HSD043I9W1_16B__
