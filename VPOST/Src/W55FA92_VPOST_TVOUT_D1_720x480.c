/**************************************************************************//**
 * @file     W55FA92_VPOST_TVOUT_D1_720x480.c
 * @version  V3.00
...
INT vpostLCMInit_TVOUT_720x480(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
    ...
    // TV control register
    vpostSetTVEnableConfig(	eDRVVPOST_D1, 					/* Frame Buffer Size in TV */
...
// 	outpw(REG_LCM_TVDisCtl, 0x10ee1593);		  	
  	outpw(REG_LCM_TVDisCtl, 0x10ee1583);		  	 	
...
INT32 vpostLCMDeinit_TVOUT_720x480(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
	return 0;
